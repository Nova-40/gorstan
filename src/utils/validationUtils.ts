...
export const ValidationRules = {
  ...
  objectHasKeys: (fieldName: string, requiredKeys: string[]): ValidationRule<Record<string, unknown>> => ({
...
export function validateObjectSchema<T extends Record<string, unknown>>(
  ...
  for (const [field, rules] of Object.entries(schema) as Array<[keyof T, ValidationRule<unknown>[]]>) {
