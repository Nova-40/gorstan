...
export const puzzleGenerators: PuzzleGenerator[] = [
  {
    ...
    algorithms: {
      ...
      hard: {
        ...
        complexity: 8,
        parameters: { steps: 10, operations: ['add', 'subtract', 'multiply', 'power', 'fibonacci', 'prime'] },
...
export const puzzleTemplates: PuzzleTemplate[] = [
  ...
  },
  {
    ...
    type: 'quantum',
    baseStructure: {
      quantumState: { superposition: false, entanglement: [], measurement: { basis: 'fire', outcome: null } },
      quantumGates: { available: [], sequence: [], target: null },
      artifactChanneling: { primaryArtifact: '', supportingArtifacts: [], resonancePattern: [] }
    },
    variables: {
      elements: { type: 'array', options: [['fire', 'water'], ['earth', 'air'], ['fire', 'earth'], ['water', 'air']] },
...
export const samplePuzzles: LogicPuzzle[] = [
  {
    ...
    puzzle: {
      ...
      explanation: 'This is an arithmetic sequence where each number increases by 2. Starting from 2, we get: 2, 4, 6, 8, 10, 12.'
    },
  ...
  
  {
    ...
    puzzle: {
      ...
      explanation: 'Quantum entanglement requires creating superposition in one artifact, then using a controlled gate to entangle it with another. The resonance pattern maintains stability during the process.'
    },
  ...
  
  {
    ...
    puzzle: {
      ...
      explanation: 'By systematically applying each clue and using elimination, we can determine that Jones is the doctor in the blue house with a dog, Brown is the teacher in the red house with a bird, and Smith is the engineer in the green house with a cat.'
    },
