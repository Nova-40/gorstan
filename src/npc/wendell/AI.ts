...
export class WendellAI {
  ...
  private addTopicKnowledge(response: WendellResponse, topic: string, context: ConversationContext): WendellResponse {
    const knowledgeMap: Record<string, string[]> = {
      tower_history: ["The tower was built in the Third Age", "Multiple civilizations have contributed to its construction"],
      magical_theory: ["Magic here follows the principle of sympathetic resonance", "Artifacts amplify natural magical abilities"],
      artifacts: ["Each artifact contains a fragment of the original enchantment", "They respond to worthy bearers"],
      knowledge: ["This library contains works from twelve different magical traditions", "Some books write themselves"],
      history: ["The tower has stood for over two millennia", "Many seekers have walked these halls"],
      warnings: ["The deeper levels hold both great power and great danger", "Not all knowledge is meant for unprepared minds"]
    };
  ...
  private addTestingQuestion(response: WendellResponse, _context: ConversationContext): WendellResponse {
