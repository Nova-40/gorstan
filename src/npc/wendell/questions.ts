...
export const wendellQuestions: ConversationQuestion[] = [
  ...
  
  {
    ...
    question: "You've encountered some of the tower's artifacts. Do you sense any connection between them?",
  ...
  
  {
    ...
    question: "In your travels, have you found any trace of others who walked these halls before you?",
  ...
  
  {
    ...
    question: "Knowledge without wisdom is mere accumulation. How do you plan to use what you've learned here?",
...
export function getQuestionsByLevel(level: 'basic' | 'intermediate' | 'advanced'): ConversationQuestion[] {
