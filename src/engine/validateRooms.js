// Gorstan v2.4.0 – Room Validation Utility
...
/**
 * Validates the Gorstan room configuration.
 * Checks for missing/invalid descriptions, exits, images, and event handlers.
 * Logs issues to the console and sets process exit code accordingly.
 */
...
// Run validation if executed directly (Node.js)
...
/*
  ...
  1. 🔍 VALIDATION
     ...
     - No unreachable code.
  2. 🔁 REFACTORING
     - Refactored into a function for modularity and testability.
     - Removed unused exports (issues, exitsResult).
  ...
  4. 🤝 INTEGRATION CHECK
     - Expects `rooms` object from rooms.js.
     - No side effects except when run as a script.
  5. 🧰 BONUS IMPROVEMENTS
     - Could add CLI options for output format or strictness.
     - Could add exportable validation results for CI integration.
     - Could add more granular checks for event handler signatures.
*/
