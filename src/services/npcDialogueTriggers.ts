...
export class NPCDialogueTriggerSystem {
  ...
  private getMrWendellDominicReaction(): string {
    ...
    return reactions[Math.floor(Math.random() * reactions.length)] || "*Mr. Wendell gives you a knowing look*";
  }
  ...
  private getPollyEvilReaction(): string {
    ...
    return reactions[Math.floor(Math.random() * reactions.length)] || "*Polly gives you a sweet, unsettling smile*";
  }
