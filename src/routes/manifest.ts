...
export const short10Routes: RouteManifest[] = [
  ...
  {
    id: 'short10_clockworkcrypt',
    label: 'Clockwork Crypt',
    targetMinutes: 10,
    description: 'Solve mechanical puzzles in a clockwork crypt while racing against ticking mechanisms.',
    hintPolicy: 'off',
    difficulty: 'veteran',
    allowedSkips: 0,
    enableFastTravel: false,
    nodes: [
      {
        id: 'clockwork_entrance',
        type: 'travel',
        required: true,
      },
      {
        id: 'clockwork_gear_puzzle',
        type: 'logicPuzzle',
        required: true,
        difficulty: 'hard',
        pauseOnModal: true,
      ...
      {
        id: 'clockwork_automaton_fight',
        type: 'combat',
        required: true,
        difficulty: 'hard',
      },
      {
        id: 'clockwork_timing_challenge',
        type: 'quest',
        required: true,
      },
      {
        id: 'clockwork_master_puzzle',
        type: 'logicPuzzle',
        required: true,
        difficulty: 'expert',
        pauseOnModal: true,
