    ...
    function nextPhase() {
      if (phase < phases.length) {
        ...
        if (typeof fn !== 'function') {
          console.warn('[DominicBirthdayHeist] Skipping missing phase function at index', phase);
          phase++;
          nextPhase();
          return;
        }
        setTimeout(() => {
          Promise.resolve(fn()).then(() => {
            ...
            console.error('[DominicBirthdayHeist] Phase error', err);
            phase++;
            nextPhase();
          });
        }, 1000);
...
function gatherIntel(): Promise<void> {
  return new Promise((resolve) => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        console.log('[DominicBirthdayHeist] Legendary Layer Cake location: Center vault, pedestal 3.');
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          ...
          setTimeout(() => {
            ...
            console.log('[DominicBirthdayHeist] Cake secured! Exiting via cookie ventilation shaft...');
            
            setTimeout(() => {
              console.log('[DominicBirthdayHeist] Clean getaway! Nobody was harmed, all debts paid!');
              resolve();
            }, 2000);
          }, 2500);
        }, 2000);
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          ...
          console.log('[DominicBirthdayHeist] His wish: "More adventures with friends like these."');
