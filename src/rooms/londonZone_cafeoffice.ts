...
const cafeoffice: Room = {
  ...
  title: 'Cafe Office',
  description: [
  "You step into a small, cluttered office behind the main cafe area. The space is cramped but functional, clearly serving as both storage and administrative center for the establishment. A modest desk sits against one wall, its surface covered with receipts, supplier invoices, and staff schedules. An old computer hums quietly, its screen displaying what appears to be point-of-sale software. Filing cabinets line another wall, their drawers slightly ajar revealing folders stuffed with paperwork. The air smells of coffee beans and old paper, with a hint of vanilla from the cafe beyond. Despite its mundane appearance, you sense there might be more to this simple office than meets the eye. Sometimes the most important things are hidden in the most ordinary places.",
],
  ...
  items: [
    { id: 'important_documents', name: 'Important Documents' },
    { id: 'staff_key_ring', name: 'Staff Key Ring' },
    { id: 'business_records', name: 'Business Records' },
    { id: 'supplier_contact_list', name: 'Supplier Contact List' },
    { id: 'safe_combination', name: 'Safe Combination' },
    { id: 'emergency_cash', name: 'Emergency Cash' },
    { id: 'inventory_clipboard', name: 'Inventory Clipboard' }
  ],
  ...
  secrets: {
    hidden_compartment: {
      description: [
  "A secret compartment behind the filing cabinet containing sensitive documents",
],
    ...
    safe_contents: {
      description: [
  "The valuable contents of the office safe beyond just cash",
],
    ...
    computer_files: {
      description: [
  "Important digital records and communications stored on the computer",
],
  ...
  customActions: {
    gather_documents: {
      description: [
  "Collect all the important business documents from various locations",
],
    ...
    secure_evidence: {
      description: [
  "Carefully document and preserve important findings",
],
    ...
    backup_computer_data: {
      description: [
  "Create copies of important digital information",
],
