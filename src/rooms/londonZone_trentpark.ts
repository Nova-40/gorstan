...
const trentpark: Room = {
  ...
  title: 'Trent Park',
  description: [
  "You find yourself in a quiet section of Trent Park, where ancient trees create natural archways overhead and dappled sunlight filters through the canopy. The peaceful atmosphere of this London green space feels almost sacred. Most of the park appears normal - joggers pass by in the distance, dog walkers follow familiar paths, and the sounds of suburban life drift softly through the air. But here, in this particular clearing, something feels different. In the center of a small grove stands a single wooden chair, weathered but sturdy, placed with deliberate intention. Around its base, carved into the earth itself, are symbols and runes that seem to pulse with an otherworldly energy. The sensation of being watched is almost overwhelming here. Eyes seem to track your every movement from the shadows between the trees, though you can never quite spot the watchers themselves.",
],
  ...
  items: [
    ...
    { id: 'ancient_acorn', name: 'Ancient Acorn' },
    { id: 'runic_rubbing_paper', name: 'Runic Rubbing Paper' },
    { id: 'observer_feather', name: 'Observer Feather' },
    { id: 'dimensional_compass', name: 'Dimensional Compass' }
  ],
  ...
  secrets: {
    rune_meanings: {
      description: [
  "The true meaning and power of the ancient symbols around the chair",
],
    ...
    watcher_purpose: {
      description: [
  "Why the hidden entities observe this place and what they're protecting",
],
    ...
    chair_origin: {
      description: [
  "The history and true purpose of the portal chair",
],
  ...
  customActions: {
    sit_in_chair: {
      description: [
  "Sit in the runic chair and activate whatever power it contains",
],
    ...
    commune_with_watchers: {
      description: [
  "Attempt to communicate with the hidden observers",
],
    ...
    study_complete_rune_circle: {
      description: [
  "Examine all the runes around the chair to understand their combined meaning",
],
