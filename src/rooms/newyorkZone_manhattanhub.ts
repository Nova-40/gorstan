...
const manhattanhub: Room = {
  ...
  description: [
  "You ascend into what appears to be a familiar New York subway station, but something feels distinctly off. The tile work is slightly different, the platform layout subtly altered, and the air hums with an energy that has nothing to do with trains. This is clearly the same physical location as a real Manhattan subway station, but shifted dimensionally into something far more significant. Advanced technology seamlessly blends with the familiar underground architecture. Multiple tunnel entrances lead off in different directions, each marked with destinations that definitely don't appear on any MTA map. Digital displays show arrival times for routes to places that shouldn't exist. A security checkpoint stands between you and the main platform area, staffed by the same professional guard you recognize from the warehouse. Albie nods in acknowledgment - but his eyes clearly check for the medallion that grants access to the restricted areas.",
],
  ...
  items: [
    { id: 'dimensional_map', name: 'Dimensional Map' },
    { id: 'station_schedule', name: 'Station Schedule' },
    { id: 'quantum_transit_guide', name: 'Quantum Transit Guide' },
    { id: 'emergency_beacon', name: 'Emergency Beacon' }
  ],

  interactables: {
    security_checkpoint: {
      description: [
  "A sophisticated security station that controls access to the main platform. Advanced scanners and verification systems are built into the familiar subway aesthetic.",
],
    ...
    albie_security_guard: {
      description: [
  "The same professional security guard from the warehouse, now manning this crucial dimensional transit hub.",
],
    ...
    dimensional_displays: {
      description: [
  "Digital boards showing departure times and destinations that include places like \"Quantum Library\", \"Crystal Gardens\", and \"Temporal Nexus\".",
],
    ...
    platform_access_gate: {
      description: [
  "A high-tech security gate disguised as a standard subway turnstile. It only responds to proper authorization.",
],
    ...
    tunnel_entrances: {
      description: [
  "Multiple tunnel mouths leading to different dimensional zones. Each is clearly marked but access is strictly controlled.",
],
    ...
    familiar_subway_elements: {
      description: [
  "Standard NYC subway fixtures - tile work, benches, and signage - but with subtle differences that mark this as a dimensional variant.",
],
  ...
  secrets: {
    hub_puzzle_solution: {
      description: [
  "The correct sequence to unlock access to the restricted dimensional zones",
],
    ...
    dimensional_map_secrets: {
      description: [
  "Hidden destinations and routes not shown on the standard displays",
],
    ...
    albie_hub_role: {
      description: [
  "Understanding Albie's role in the broader interdimensional network",
],
  ...
  customActions: {
    present_medallion_to_albie: {
      description: [
  "Show the medallion obtained from the warehouse briefcase to gain platform access",
],
      requirements: ['medallion_from_warehouse_puzzle'],
      effects: [
        'gain_platform_access',
        'unlock_dimensional_destinations',
        'activate_transit_options',
      ],
    },
    solve_hub_transit_puzzle: {
      description: [
  "Complete the dimensional routing puzzle to unlock access to the next zones",
],
    ...
    attempt_unauthorized_access: {
      description: [
  "Try to bypass security without proper credentials",
],
      requirements: [],
