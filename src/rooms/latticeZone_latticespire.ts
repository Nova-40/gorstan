...
const latticespire: Room = {
  ...
  title: 'Lattice Spire',
  description: [
  "You stand within the Lattice Spire, a towering crystalline structure that rises above the rest of the lattice. The walls are composed of interlocking crystal facets, each pulsing with energy and shifting patterns of light. A spiral ramp winds upward, offering a dizzying view of the lattice network below. At the summit, a control node glows with immense power, humming with the resonance of the entire zone.",
],
  ...
  items: [
    { id: 'spire_key', name: 'Spire Key' },
    { id: 'crystal_fragment', name: 'Crystal Fragment' },
    { id: 'energy_map', name: 'Energy Map' },
    { id: 'control_rune', name: 'Control Rune' }
  ],
  ...
  "Synchronize the spire's energy with the rest of the lattice.",
    ...
    observe_patterns: {
      description: [
  "Observe and analyze energy patterns from the facet window.",
],
      requirements: [],
