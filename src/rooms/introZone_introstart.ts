...
const introstart: Room = {
  ...
  title: 'The Aftermath',
  description: [
  "You find yourself standing in what appears to be an ordinary street corner, but something feels fundamentally wrong. The air carries an eerie stillness, as if the world itself is holding its breath. A coffee cup lies on the ground nearby, steam still rising from its contents despite the unnatural quiet. The liquid inside seems to shimmer with an otherworldly quality. The shadows here are deeper than they should be, and you can't shake the feeling that you're being watched. Shapes seem to move at the edge of your vision, but when you turn to look, there's nothing there. This place feels like the echo of something significant - a moment frozen in time where reality itself might have shifted. The very air hums with residual energy from some cosmic event.",
],
  ...
  items: [
    { id: 'dimensional_coffee', name: 'Dimensional Coffee' },
    { id: 'memory_fragment', name: 'Memory Fragment' },
    { id: 'reality_shard', name: 'Reality Shard' },
    { id: 'temporal_residue', name: 'Temporal Residue' }
  ],
  ...
  secrets: {
    lorry_memory: {
      description: [
  "Fragmented memories of the lorry incident that triggered the reset",
],
    ...
    watcher_origins: {
      description: [
  "The true nature and purpose of the shadow watchers",
],
    ...
    temporal_scar: {
      description: [
  "Evidence of the exact moment reality was torn and reformed",
],
  ...
  customActions: {
    pick_up_coffee: {
      description: [
  "Carefully pick up the dimensional coffee from the ground",
],
      requirements: [],
    ...
    commune_with_shadows: {
      description: [
  "Attempt to communicate with the watching entities",
],
    ...
    piece_together_memories: {
      description: [
  "Try to understand what happened using the evidence around you",
],
