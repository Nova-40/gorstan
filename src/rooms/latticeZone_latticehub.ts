...
const latticehub: Room = {
  ...
  description: [
  "You step into a chamber that defies comprehension - the very core of reality itself. Crystalline structures of impossible geometry stretch in all directions, their surfaces pulsing with the fundamental forces that bind nine universes together. The architecture is ancient beyond measure, crafted by hands that shaped the cosmos itself. Quantum energy flows through crystalline conduits like liquid light, maintaining the delicate balance that allows multiple realities to coexist. As you enter, the chamber's defenses activate - but something extraordinary happens. The lethal energy barriers flicker and fade, the guardian constructs power down, and the quantum locks disengage with soft chimes of recognition. A melodic voice echoes through the chamber: \"Welcome home, Architect. The Lattice recognizes your essence. The long plan nears completion.\" The room treats you not as an intruder, but as its rightful inheritor.",
],
  ...
  items: [
    { id: 'architect_recognition_crystal', name: 'Architect Recognition Crystal' },
    { id: 'quantum_manipulation_primer', name: 'Quantum Manipulation Primer' },
    { id: 'lattice_control_interface', name: 'Lattice Control Interface' },
    { id: 'multiversal_map', name: 'Multiversal Map' },
    { id: 'architect_genetic_scanner', name: 'Architect Genetic Scanner' },
    { id: 'reality_anchor_core', name: 'Reality Anchor Core' }
  ],

  interactables: {
    lattice_core: {
      description: [
  "The crystalline heart of the multiverse, pulsing with the energy that maintains reality itself. It recognizes you as its creator's heir.",
],
    ...
    quantum_conduits: {
      description: [
  "Streams of pure quantum energy flowing through crystalline channels, carrying the forces that enable magic across all nine universes.",
],
    ...
    architect_console: {
      description: [
  "An ancient control interface that awakens at your approach. Symbols in a long-dead language shift to match your understanding.",
],
    ...
    security_systems: {
      description: [
  "Deactivated defensive measures that would have been lethal to anyone else. They recognize your genetic signature as that of their builders.",
],
    ...
    temporal_resonance_chamber: {
      description: [
  "A space where time flows differently, allowing glimpses of the past and future. Here, the Great Plan's scope becomes clear.",
],
    ...
    genetic_archive: {
      description: [
  "Ancient storage containing the genetic templates of the Architect race. Your DNA matches patterns stored here millennia ago.",
],
  ...
  secrets: {
    architect_origin: {
      description: [
  "The true history of the Architect race and their role in creating the multiverse",
],
    ...
    great_plan_scope: {
      description: [
  "The full scope of the millennia-long plan to recreate the Architect race",
],
    ...
    quantum_magic_mastery: {
      description: [
  "Understanding how to manipulate quantum forces as the Architects did",
],
  ...
  customActions: {
    commune_with_lattice: {
      description: [
  "Establish a direct connection with the multiversal core",
],
    ...
    access_architect_heritage: {
      description: [
  "Fully embrace your identity as an Architect descendant",
],
      requirements: ['genetic_archive_accessed', 'heritage_confirmed'],
      effects: [
        'gain_architect_abilities',
        'unlock_ancient_knowledge',
        'accept_cosmic_responsibility',
      ],
    },
    understand_great_plan: {
      description: [
  "Comprehend the millennia-long strategy to recreate your race",
],
