...
const mazeecho: Room = {
  ...
  quests: {
    ...
    optional: ['Mark the Echo Wall', 'Meet the Echo Wanderer', 'Listen to the Reflection Pool'],
  },
  ...
  metadata: {
    ...
    keyFeatures: ['Echo-based puzzles', 'Auditory illusions', 'Wandering NPC', 'Reflection pool'],
  },
