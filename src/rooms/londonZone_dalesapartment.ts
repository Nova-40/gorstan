...
const dalesapartment: Room = {
  ...
  description: [
  "You step into a bright, immaculately clean apartment that feels almost unnaturally tidy. Every surface gleams, every book is perfectly aligned, and not a single item appears out of place. The living room is decorated in modern minimalist style with clean lines and neutral colors. A comfortable sofa faces a wall-mounted television, while floor-to-ceiling windows flood the space with natural light. In one corner of the lounge, a large fish tank bubbles quietly. Inside, a single goldfish named Dominic swims in lazy circles, seemingly the only living thing that doesn't conform to the apartment's rigid organization. The level of tidiness borders on obsessive - it's as if someone has been maintaining this place as a shrine, keeping everything exactly as it was meant to be, waiting for its occupants to return.",
],
  ...
  items: [
    { id: 'apartment_keys', name: 'Apartment Keys' },
    { id: 'photo_albums', name: 'Photo Albums' },
    { id: 'shared_calendar', name: 'Shared Calendar' },
    { id: 'travel_brochures', name: 'Travel Brochures' },
    { id: 'emergency_contact_list', name: 'Emergency Contact List' },
    { id: 'goldfish_food', name: 'Goldfish Food' },
    { id: 'remote_control', name: 'Remote Control' },
  ...
  secrets: {
    hidden_runbag_location: {
      description: [
  "The travel bag packed and ready in the bedroom",
],
    ...
    dominic_intelligence: {
      description: [
  "Discover the true intelligence behind Dominic's eyes",
],
  ...
  customActions: {
    feed_dominic: {
      description: [
  "Give Dominic his daily feeding and spend time with him",
],
    ...
    appreciate_tidiness: {
      description: [
  "Take time to truly appreciate the incredible organization of the apartment",
],
    ...
    piece_together_life: {
      description: [
  "Use photos and belongings to understand Dale and Polly's relationship",
],
    ...
    look_for_remote_control: {
      description: [
  "Search specifically for the missing remote control",
],
    ...
    find_runbag: {
      description: [
  "Search the bedroom area for travel preparations",
],
      requirements: ['explore bedroom area', 'examine travel preparations'],
