...
const burgerjoint: Room = {
  ...
  description: [
  "You step into a classic New York burger joint that looks like it's been serving the neighborhood for decades. Red vinyl booths line the walls, and the black-and-white checkered floor shows years of faithful service. The smell of grilling beef and fresh fries fills the air, making your mouth water despite everything else going on. A large grill dominates the open kitchen, where a burly chef works with practiced efficiency. Behind the counter, menu boards display simple offerings - burgers, fries, sodas, and not much else. This is the kind of place that does one thing and does it perfectly. The chef looks up as you enter, wiping his hands on his apron. He has the weathered look of someone who's seen it all, but his eyes hold a sharpness that suggests there's more to this place than meets the eye.",
],
  ...
  items: [
    { id: 'burger_menu', name: 'Burger Menu' },
    { id: 'napkin_dispenser', name: 'Napkin Dispenser' },
    { id: 'salt_and_pepper', name: 'Salt And Pepper' },
    { id: 'hot_sauce_bottles', name: 'Hot Sauce Bottles' }
  ],
  ...
  traps: [
    {
      ...
      severity: 'minor',
      description: [
  "You accidentally brush against the hot grill while exploring! The searing metal burns your arm!",
],
      trigger: 'enter',
      effect: {
        damage: 8,
  ...
  interactables: {
    burger_chef: {
      description: [
  "A experienced chef who takes pride in his burgers. His eyes suggest he knows more than he lets on about certain... arrangements.",
],
    ...
    kitchen_grill: {
      description: [
  "A well-maintained commercial grill where the magic happens. The chef works it like a master craftsman.",
],
    ...
    menu_board: {
      description: [
  "Simple black board with white letters: Burgers, Fries, Coke, Coffee. Prices are reasonable and the quality is legendary.",
],
    ...
    vinyl_booths: {
      description: [
  "Classic red vinyl booths that have probably heard a thousand conversations over the years.",
],
    ...
    portal_booth: {
      description: [
  "One particular booth in the back corner that seems to shimmer slightly. The vinyl looks newer, and sitting here feels different from the other booths.",
],
    ...
    storeroom_door: {
      description: [
  "A plain door behind the counter marked \"Storage\". The chef has offered to let you take a look inside.",
],
  ...
  secrets: {
    chef_connections: {
      description: [
  "The chef's relationship with the warehouse operation and other underground services",
],
    ...
    storeroom_contents: {
      description: [
  "Useful items the chef allows authorized visitors to take",
],
    ...
    burger_recipe: {
      description: [
  "The secret to making the legendary burgers (seriously, they're that good)",
],
  ...
  customActions: {
    place_correct_order: {
      description: [
  "Order burger, fries, and coke as instructed in the note",
],
    ...
    give_password_aevira: {
      description: [
  "Provide the password \"aevira\" to the chef",
],
    ...
    explore_storeroom: {
      description: [
  "Check out what the chef is offering from his storage area",
],
