...
const echochamber: Room = {
  ...
  quests: {
    ...
    optional: ['Mark the Resonance Wall', 'Meet the Echo Savant', 'Stand on the Central Dais'],
  },
  ...
  metadata: {
    ...
    keyFeatures: ['Echo-based puzzles', 'Acoustic illusions', 'Echo Savant NPC', 'Central dais'],
  },
