...
const storagechamber: Room = {
  ...
  description: [
  "You enter an abandoned storage chamber deep within the maze. The air is stale and thick with dust, suggesting this place has been forgotten for years. Broken crates and barrels are scattered throughout the room, their contents long since looted or rotted away. Rusty shelving units lean precariously against the damp stone walls. In one corner sits a once-elegant chair, now broken and decrepit. One of its legs is cracked, the upholstery is torn and faded, and it looks like it might collapse if sat upon. Despite its deteriorated state, there's something oddly compelling about the broken chair—as if it once served a purpose far more important than mere seating.",
],
  ...
  items: [
    { id: 'broken_crate_splinter', name: 'Broken Crate Splinter' },
    { id: 'rusty_nail', name: 'Rusty Nail' },
    { id: 'torn_fabric_scrap', name: 'Torn Fabric Scrap' },
    { id: 'moldy_grain', name: 'Moldy Grain' }
  ],
  ...
  environmental: {
    ...
    soundscape: ['creaking_wood', 'dripping_water', 'settling_debris', 'distant_echoes'],
  ...
  "Attempt to repair the broken chair using available materials.",
    ...
    organize_debris: {
      description: [
  "Sort through the debris to find useful items.",
],
      requirements: [],
