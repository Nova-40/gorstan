...
const ancientsroom: Room = {
  ...
  quests: {
    ...
    optional: ['Examine the Artifact', 'Decode the Glyphic Walls', 'Meet the Ancient Attendant'],
  },
  ...
  environmental: {
    ...
    soundscape: ['soft_hum', 'whispered_glyphs'],
  ...
  metadata: {
    ...
    keyFeatures: ['Private chamber', 'Artifact puzzle', 'Glyphic lore', 'Guardian NPC'],
  },
