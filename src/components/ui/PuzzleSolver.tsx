...
const PuzzleSolver: React.FC<PuzzleSolverProps> = ({
  ...
  const handleArtifactActivation = (artifactId: string, interactionType: string) => {
    ...
    const totalResonance = Object.values(newStates).reduce(
      (sum, state: any) => sum + (state.active ? state.resonance : 0),
      0,
    );
  ...
  const renderPuzzleContent = () => {
    switch (puzzle.type) {
      ...
      case 'grid':
        return <div className="text-center text-gray-400 py-8">Grid puzzles coming soon...</div>;
      case 'logic':
        return <div className="text-center text-gray-400 py-8">Logic puzzles coming soon...</div>;
      case 'cipher':
        return <div className="text-center text-gray-400 py-8">Cipher puzzles coming soon...</div>;
      case 'quantum':
      case 'artifact':
        return (
          <QuantumPuzzleRenderer
    ...
    >
      <div className="max-w-6xl w-full h-full max-h-[95vh] bg-gray-800 border border-gray-600 rounded-lg overflow-hidden flex flex-col">
        ...
        <div className="flex-1 flex overflow-hidden">
          {/* Puzzle Area */}
          <div className="flex-1 p-6 overflow-y-auto">{renderPuzzleContent()}</div>
              ...
              <div className="space-y-2 text-xs">
                ...
                {puzzle.progression.rewards.artifactProgression && (
                  <div className="mt-2">
                    ...
                    {Object.entries(puzzle.progression.rewards.artifactProgression).map(
                      ([id, amount]) => (
...
const SequencePuzzleRenderer: React.FC<{
  puzzleData: SequencePuzzle;
  ...
  <div className="space-y-4">
        ...
        >
          {value === null ? (
            <input
              ...
              onChange={(e) =>
                onMove('fill_sequence', { index, value: parseInt(e.target.value) || 0 })
              }
            />
          ) : (
            String(value)
    ...
    <div className="text-sm text-gray-400">Pattern: {puzzleData.pattern.rule}</div>
  </div>
);
      ...
      <div className="bg-gray-700 rounded p-4">
        ...
        <div className="space-y-2 text-sm">
          <div className="flex justify-between">
            ...
            <span
              className={puzzleData.quantumState.superposition ? 'text-green-400' : 'text-red-400'}
            >
        ...
        <div className="space-y-2 text-sm">
          <div className="flex justify-between">
            ...
            <span className="text-green-400">
              {puzzleData.quantumGates.target.entangled ? 'Yes' : 'No'}
            </span>
          </div>
        </div>
      </div>
