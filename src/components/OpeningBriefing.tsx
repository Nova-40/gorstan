      ...
      <section className="max-w-2xl border border-green-500 bg-[#08151c] p-5 font-mono text-green-300 shadow-2xl">
        ...
        <div className="space-y-3 text-sm leading-relaxed">
          ...
          <p>
            ...
            <strong>help</strong>. Clickable exits and hotspots send ordinary commands through the
            same parser route.
          </p>
          <p>
            Exits appear in the action panel and, where room art has been mapped, as hotspots in the
            scene. Inventory, status, save/load, NPC help, and room inspection remain available from
            the command line or the surrounding panels.
          </p>
        </div>
