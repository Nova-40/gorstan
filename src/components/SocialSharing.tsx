...
export const SocialSharing: React.FC<SocialSharingProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'achievements' | 'discoveries' | 'stats'>(
    'achievements',
  );
  const [selectedItem, setSelectedItem] = useState<
    ShareableAchievement | ShareableDiscovery | null
  >(null);
            ...
            <div className="space-y-4">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-400">
                  Let others know about the amazing places you've found
                </p>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-800 rounded-lg p-4 border border-gray-700">
                ...
                <div className="space-y-2 text-sm text-gray-300">
                  ...
                  <p>
                    • {Math.floor(Math.random() * 500) + 100} players have visited the same rooms as
                    you
                  </p>
                  <p>
                    • Your achievement score ranks {Math.floor(Math.random() * 50) + 10}th globally
                  </p>
                </div>
              </div>
            </div>
