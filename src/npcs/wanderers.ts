...
// Helper: normalize a loose wanderer object into a runtime-rich NPC while
// satisfying the strict `NPC` type for TypeScript. We intentionally build
// a minimal, typed NPC shape and then merge the original object to preserve
// runtime-only fields like `canWander` or `personality` that other code uses.
function normalizeNPC(obj: Record<string, any>): NPC {
  ...
  // Merge runtime extras so behavior is unchanged at runtime; cast via unknown
  // to avoid introducing `any` broadly while still telling TS this is an NPC.
  const full = { ...base, ...obj };
  return full as unknown as NPC;
}
...
export const al: NPC = normalizeNPC({
  ...
  personality:
    'Bureaucratic and methodical, Al is obsessed with proper procedures and documentation. He speaks formally but can be helpful when approached correctly.',
  ...
  conversation: [
    ...
    },
    {
      ...
      responses: [
        ...
        {
          text: 'What if both structure and intuition have their place?',
          nextId: 'balanced_approach',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      responses: [
        ...
        {
          text: 'I appreciate the effort, but I need to choose one path.',
          nextId: 'reject_compromise',
        },
      ],
    },
    {
      ...
      responses: [
        ...
        {
          text: 'Morthos called you a bureaucrat. How do you respond?',
          nextId: 'bureaucrat_response',
        },
    ...
    },
    {
      ...
      responses: [
        ...
        {
          text: 'Morthos, how do you respond to being called reckless?',
          nextId: 'reckless_accusation',
        },
  ...
  topics: [
    {
      triggers: ['help', 'assistance', 'guidance'],
      response:
        "Of course! I'm here to help ensure proper procedures are followed. What do you need assistance with? *whispers* Unlike certain shadow-dwellers who offer only cryptic riddles.",
    },
    {
      triggers: ['forms', 'paperwork', 'documentation'],
      response:
        '*perks up considerably* Ah, excellent! Proper documentation is the backbone of any well-functioning organization. I can get you properly certified, unlike those who encourage reckless abandon.',
    },
    {
      triggers: ['morthos', 'shadows', 'dark'],
      response:
        "*adjusts glasses nervously* Morthos... yes, well, he operates somewhat outside normal protocols. Don't let his mystical speeches fool you - structure and order are what keep us safe. Choose your allies wisely.",
    },
    {
      triggers: ['regulations', 'rules', 'procedures'],
      response:
        "Regulations exist to maintain order and safety across the multiverse. I have complete documentation if you're interested. Much more reliable than trusting 'cosmic intuition.'",
    },
    {
      triggers: ['ally', 'alliance', 'partnership'],
      response:
        "*eyes light up* Now you're speaking my language! A formal alliance would be mutually beneficial. I can offer resources, authority, and proper channels. What do you say?",
    },
    {
      triggers: ['chaos', 'disorder', 'confusion'],
      response:
        "*shakes head sadly* Too much chaos in this facility already. That's why we need more people willing to stand for order and proper procedure. Will you be one of them?",
    },
  ],
  customResponses: {
    thanks:
      "You're quite welcome. Remember, proper procedures benefit everyone - unlike certain chaotic influences around here.",
    goodbye:
      "*tips hat* Safe travels, and remember to file your travel reports! And... do consider what I've said about reliable allies.",
    complaint:
      "*sighs and pulls out complaint form* I'll need you to fill out Form 15-C for any formal grievances. At least I provide proper channels for resolution.",
    morthos:
      '*frowns deeply* That shadow-dweller offers grand promises but no concrete benefits. Stick with proven systems and legitimate authority.',
...
export const morthos: NPC = normalizeNPC({
  ...
  personality:
    'Mysterious and otherworldly, Morthos speaks in riddles and metaphors. He seems to know more than he lets on about the nature of reality and the multiverse.',
  ...
  topics: [
    {
      triggers: ['shadows', 'darkness', 'mystery'],
      response:
        'Shadows are not the absence of light, but the presence of potential. In darkness, all possibilities exist simultaneously. Will you learn to see with new eyes?',
    },
    {
      triggers: ['al', 'bureaucrat', 'administrator'],
      response:
        '*amused* Ah, dear Al. His need for order is... quaint. But tell me, do you wish to be a cog in his machine, or would you rather become the engineer of your own destiny?',
    },
    {
      triggers: ['reality', 'truth', 'existence'],
      response:
        'Reality is but a consensus among observers. Change the observer, change the reality. I can teach you to become a reality architect, unlike those who merely file reports about it.',
    },
    {
      triggers: ['fear', 'scary', 'frightening'],
      response:
        'Fear often precedes growth. Al offers you comfort in stagnation; I offer transformation through challenge. Which serves your greater purpose?',
    },
    {
      triggers: ['power', 'abilities', 'magic'],
      response:
        "*eyes gleam* Now you understand. True power lies not in following procedures, but in transcending them. Shall I show you what lies beyond the bureaucrat's limited vision?",
    },
    {
      triggers: ['alliance', 'ally', 'student'],
      response:
        'An alliance with me means stepping beyond mortal limitations. While Al offers you safety, I offer you sovereignty. Choose your path wisely, seeker.',
    },
    {
      triggers: ['freedom', 'choice', 'independence'],
      response:
        'Freedom cannot be granted by forms and regulations - it must be seized and wielded. I can teach you to break the chains that bind lesser minds.',
    },
  ],
  customResponses: {
    thanks:
      'Gratitude... such a beautiful ripple in the fabric of interaction. Remember this feeling when choosing your path forward.',
    goodbye:
      '*nods knowingly* Until the threads of fate weave our paths together again... choose your allies with wisdom, not fear.',
    ...
    power:
      'Power is not given - it is claimed by those bold enough to reach beyond the safety of the known. Will you remain a follower, or become a force of change?',
  },
  memory: {
    interactions: 0,
    lastInteraction: 0,
...
export const polly: NPC = normalizeNPC({
  ...
  mood: 'neutral',
  personality:
    'Energetic and inquisitive, Polly is always exploring and discovering new things. She has a knack for finding hidden passages and secret areas.',
  ...
  topics: [
    {
      triggers: ['maze', 'labyrinth', 'lost'],
      response:
        'The maze can be tricky, but I know every twist and turn! The key is to listen for the echoes - they tell you which way leads to open spaces.',
    },
    {
      triggers: ['treasure', 'items', 'loot'],
      response:
        "*gets excited* Oh, I've found the most amazing things! Keys, maps, mysterious artifacts... want to go treasure hunting together?",
    },
    {
      triggers: ['danger', 'scary', 'monsters'],
      response:
        "There are some creepy areas, but I've learned to be careful. Most scary things just want to be left alone anyway.",
    },
  ],
  customResponses: {
...
export const wendell: NPC = normalizeNPC({
  ...
  mood: 'neutral',
  personality:
    'A distinguished gentleman scholar with vast knowledge of the multiverse. He speaks eloquently and enjoys sharing wisdom, though he can be somewhat absent-minded.',
  ...
  topics: [
    {
      triggers: ['research', 'study', 'knowledge'],
      response:
        'Ah, a fellow seeker of knowledge! There is always more to learn about the infinite complexities of existence.',
    },
    {
      triggers: ['books', 'library', 'reading'],
      response:
        "*eyes light up* Books are windows into other minds, other worlds, other possibilities. I have quite a collection if you're interested!",
    },
    {
      triggers: ['magic', 'arcane', 'mystical'],
      response:
        "Magic, as I understand it, is simply science we haven't fully quantified yet. The manipulation of dimensional energies follows its own logical principles.",
    },
    {
      triggers: ['confusion', 'lost', 'help'],
      response:
        'Of course, my dear fellow! Navigation through the multiverse can be quite bewildering. Perhaps I can offer some guidance?',
    },
  ],
  customResponses: {
    thanks: '*nods warmly* Think nothing of it! Knowledge shared is knowledge multiplied.',
    goodbye:
      'Farewell! May your journeys through the infinite be filled with wonder and discovery!',
    boring:
      "*chuckles good-naturedly* Ah, I do tend to get carried away with theoretical discussions. Perhaps you'd prefer more practical matters?",
  },
  memory: {
    interactions: 0,
    lastInteraction: 0,
...
export const dominic: NPC = normalizeNPC({
  ...
  mood: 'neutral',
  personality:
    'A laid-back and streetwise individual who knows how to survive in any environment. Dominic is practical, friendly, and has a good sense of humor.',
  ...
  topics: [
    {
      triggers: ['help', 'assistance', 'trouble'],
      response: 'Always happy to lend a hand. What kind of situation are you dealing with?',
    },
    {
      triggers: ['food', 'hungry', 'eat'],
      response:
        "*grins* Know all the best spots for grub around here. This burger joint isn't bad, but I know some hidden gems too.",
    },
    {
      triggers: ['danger', 'safety', 'protection'],
      response:
        "Hey, no worries. I've got your back. Just stay alert and don't go wandering into the really weird areas alone.",
    },
    {
      triggers: ['friends', 'lonely', 'company'],
      response:
        "You've got a friend in me, no question. Nobody should have to navigate this place solo.",
    },
  ],
  customResponses: {
    ...
    worried:
      "Hey, don't stress too much. Things have a way of working out, especially if you've got good people around you.",
  },
  memory: {
    interactions: 0,
    lastInteraction: 0,
