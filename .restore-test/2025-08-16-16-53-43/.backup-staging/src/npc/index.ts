...
export const wanderingShadows = [
  {
    ...
    name: 'Weak Shadow',
    strength: 1,
    description: 'A faint shadow, barely holding form. Easy to defeat.',
  },
  {
    id: 'shadow_moderate',
    name: 'Moderate Shadow',
    strength: 3,
    description: 'A shadow with a more defined form. Poses a slight challenge.',
  },
  {
    id: 'shadow_strong',
    name: 'Strong Shadow',
    strength: 5,
    description: 'A menacing shadow, radiating dark energy. Requires effort to defeat.',
  },
  {
    id: 'shadow_elite',
    name: 'Elite Shadow',
