      ...
      >
        ...
        {phase === 'tension' && (
          <>
            <motion.div
              ...
              style={{
                background: 'radial-gradient(circle at 80% 20%, #440000 0%, transparent 60%)',
              }}
            />
            {}
            {[...Array(3)].map((_, i) => (
        ...
        {phase === 'impact' && (
          <>
            ...
            <motion.div
              ...
              transition={{ duration: 0.5 }}
              style={{
                background: 'radial-gradient(circle, #ffffff 0%, #ff4444 20%, transparent 60%)',
        ...
        {phase === 'void' && (
          ...
          >
            ...
            >
              <div className="text-2xl mb-4" style={{ textShadow: '0 0 20px #ffffff' }}>
                ⚫ THE VOID ⚫
              </div>
