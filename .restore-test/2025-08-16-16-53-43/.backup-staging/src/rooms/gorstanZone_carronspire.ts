...
const carronspire: Room = {
  ...
  interactables: {
    ...
    "rune_panel": {
      description: "A section of the spire covered in glowing runes. Some appear to be interactive.",
  ...
  secrets: {
    hidden_chamber: {
      description: "A concealed chamber halfway up the spire, accessible only by activating the correct runes.",
