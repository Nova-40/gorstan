...
const ENTITY_PATTERNS: Record<string, RegExp[]> = {
  ...
  directions: [
    /\b(north|south|east|west|up|down|jump|sit|back|out)\b/gi
  ]
};
...
function extractEntities(utterance: string): string[] {
  ...
  for (const [_category, patterns] of Object.entries(ENTITY_PATTERNS)) {
 ...
 */
export function isPuzzleSolutionRequest(utterance: string, entities: string[]): {
