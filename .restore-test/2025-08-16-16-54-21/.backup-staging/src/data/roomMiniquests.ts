    ...
    miniquests: [
      {
        ...
        description:
          'The shifting Fae script on the standing stones holds secrets. Try "inspect stones" or bring an ancient scroll to unlock their meaning.',
        type: 'structured',
        rewardPoints: 25,
      ...
      },
      {
        ...
        description:
          'The towering oaks whisper secrets in the wind. Use "listen" near the trees and wait patiently.',
        type: 'dynamic',
        rewardPoints: 15,
    ...
    miniquests: [
      {
        ...
        description:
          'The lake\'s surface shows glimpses of other worlds. Use "examine reflections" to peer into distant dimensions.',
        type: 'exploration',
        rewardPoints: 20,
      ...
      },
      {
        ...
        description:
          'The silver sand chimes underfoot. Gather some with "gather sand" to capture its musical essence.',
        type: 'dynamic',
        rewardPoints: 10,
    ...
    miniquests: [
      {
        ...
        description:
          'Strange symbols on the floor glow with cold blue light. Use "trace symbols" to understand their painful patterns.',
        type: 'puzzle',
        rewardPoints: 35,
      ...
      },
      {
        ...
        description:
          'Chains of silver and starlight hum with contained power. Use "listen chains" to hear their song.',
        type: 'dynamic',
        rewardPoints: 15,
    ...
    miniquests: [
      {
        ...
        description:
          'The fountain\'s magical waters might grant a heartfelt wish. Use "toss coin" and make a sincere wish.',
        type: 'social',
        rewardPoints: 15,
      ...
      },
      {
        ...
        description:
          'The notice board has cryptic messages between the obvious postings. Use "search board" to find hidden meaning.',
        type: 'puzzle',
        rewardPoints: 20,
    ...
    miniquests: [
      {
        ...
        description:
          'The village baker loves to exchange tales. Use "tell story" after buying bread to share experiences.',
        type: 'social',
        rewardPoints: 18,
      ...
      },
      {
        ...
        description:
          'The village blacksmith poses riddles about metalwork. Use "answer riddle" when you think you know.',
        type: 'puzzle',
        rewardPoints: 25,
    ...
    miniquests: [
      {
        ...
        description:
          'Dominic seems unusually perceptive. Use "discuss philosophy" to engage in deep conversation.',
        type: 'social',
        rewardPoints: 22,
      ...
      },
      {
        ...
        description:
          'Everything is arranged with mathematical precision. Use "measure distances" to understand the pattern.',
        type: 'puzzle',
        rewardPoints: 30,
    ...
    miniquests: [
      {
        ...
        description:
          'Dark shapes flit between trees. Use "acknowledge presence" to show you\'re aware of being observed.',
        type: 'exploration',
        rewardPoints: 20,
      ...
      },
      {
        ...
        description:
          'This clearing feels like a natural temple. Use "meditate" to connect with its energy.',
        type: 'dynamic',
        rewardPoints: 15,
    ...
    miniquests: [
      {
        ...
        description:
          'Glowing symbols appear near certain doors. Use "decipher symbols" to understand their meaning.',
        type: 'puzzle',
        rewardPoints: 25,
      ...
      },
      {
        ...
        description:
          'The Pathway Guardian appears when you\'re not looking directly. Use "ask for guidance" when they manifest.',
        type: 'social',
        rewardPoints: 30,
    ...
    miniquests: [
      {
        ...
        description:
          'The sorrowful apparition poses ancient riddles. Use "answer riddle" to respond to their challenge.',
        type: 'puzzle',
        rewardPoints: 28,
      ...
      },
      {
        ...
        description:
          'Faded markings on the wall might be a map or code. Use "trace markings" to understand their pattern.',
        type: 'structured',
        rewardPoints: 20,
    ...
    miniquests: [
      {
        ...
        description:
          'The warning suggests the pond triggers unknown effects. Use "touch water" to discover what happens.',
        type: 'exploration',
        rewardPoints: 25,
      ...
      },
      {
        ...
        description:
          'The hanging lanterns wait to be lit. Use "light lanterns" with the lantern fragment.',
        type: 'dynamic',
        rewardPoints: 15,
