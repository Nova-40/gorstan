...
export interface GameActionContext {
  ...
  traits: string[];
  flags: Record<string, boolean | number | string>;
  npcsInRoom: NPC[]; // Use canonical NPC type
  name?: string;
  health?: number;
  topic?: string;
...
export interface LocalGameState {
  ...
  playerName?: string; // Add playerName to the LocalGameState interface
  hasMagic?: boolean; // Add hasMagic to the LocalGameState interface
}
...
export interface Quest {
  ...
  onComplete: (gameState: LocalGameState) => void;
}
