...
Respond with just the hint text, in Ayla's voice with appropriate cosmic imagery.`;
   ...
   */
  private generateScriptedHint(_context: AylaHintContext, stuckState: any): AylaHintResponse {
    const scriptedHints = {
      navigation: [
    ...
    return {
      ...
      hintText,
      urgency: 'medium',
      hintType: this.categorizeHint(_context, stuckState),
   ...
   */
  setUnifiedAIEnabled(_enabled: boolean): void {
    // Implementation removed - unused property
  }
}
