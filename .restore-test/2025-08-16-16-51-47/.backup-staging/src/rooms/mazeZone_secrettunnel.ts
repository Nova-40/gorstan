...
const secrettunnel: Room = {
  ...
  quests: {
    ...
    optional: ['Collect Glowing Moss', 'Meet the Tunnel Shadow', 'Peer Through the Hidden Crack'],
  },
  ...
  environmental: {
    ...
    soundscape: ['dripping_water', 'distant_echoes'],
  ...
  metadata: {
    ...
    keyFeatures: ['Hidden tunnel', 'Environmental hazards', 'Collectible moss', 'Shadowy NPC'],
  },
